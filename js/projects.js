const projects = [
    ...
    },
    {
        ...
        description: "Spirit Bathhouse is a roguelite deck-building game inspired by Spirited Away, created during a game jam with fellow developers. Players must race against time to bathe spirits, keep them happy to earn tips,"
    ...
    {
        id: 5,
        title: "JavaScript Detective Game",
        media: [
            { type: "image", source: "/api/placeholder/600/400" },
            { type: "image", source: "/api/placeholder/600/400" },
            { type: "image", source: "/api/placeholder/600/400" }
